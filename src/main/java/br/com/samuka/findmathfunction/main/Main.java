 ...
 */
package br.com.samuka.findmathfunction.main;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            loader = new FXMLLoader(getClass().getResource(Uteis.DIR_VIEW + "principal.fxml"));
            root = loader.load();
            
            Scene scene = new Scene(root);
            scene.getStylesheets().add(getClass().getResource(Uteis.DIR_CSS + "principal.css").toExternalForm());
